...
// Check for a first name:
    if (empty($_POST[‘first_name’])) {
     ...
     if (empty($errors)) { 
        ...
        <p>You are now registered. In Chapter 12 you will actually be able to log in!
          </p><p><br></p>’;
           ...
           // Debugging message:
           cecho ‘<p>’ . mysqli_error($dbc) . ‘<br><br>Query: ‘ . $q . ‘</p>’;
...
<form action=”register.php” method=”post”>
   ...
   <p>Email Address: <input type=”email” name=”email” size=”20” maxlength=”60” value=”<?php if
